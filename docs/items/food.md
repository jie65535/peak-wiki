...
- 增加额外体力
- 在营火处做20次饭可获得**烹饪奖章**
- **烹饪爆炸**：某些食物烹饪后会产生爆炸效果，向周围玩家施加该食物的使用效果（AOE范围效果）
...
- **饥饿恢复**：-5（烹饪后：-10）
- **额外体力**：无（烹饪后：+10）
- **特殊效果**：每天随地图更新随机生成，可能包括：眼睛被蛛网缠住、获得大量孢子、短时间无限体力等。每种颜色的效果确定后当天不变，第二天更新
- **重量**：2.5
- **位置**：森蕈
...
### ![icon](../images/items/x64/Energy%20Drink.png) 能量饮料 (Energy Drink)
- **饥饿恢复**：-20
- **额外体力**：+20
- **重量**：2.5
- **获取**：行李箱

### ![icon](../images/items/x64/Sports%20Drink.png) 运动饮料 (Sports Drink)
- **饥饿恢复**：-10
- **额外体力**：+30
- **重量**：2.5
- **获取**：行李箱

### ![icon](../images/items/x64/ScoutCookies.png) 童军饼干 (Scout Cookies)
- **饥饿恢复**：-10
- **额外体力**：+10
- **重量**：2.5
- **获取**：行李箱

### ![icon](../images/items/x64/Marshmallow.png) 棉花糖 (Marshmallow)
- **饥饿恢复**：-5
- **额外体力**：+5
- **重量**：0
- **特点**：可在营火处烤制
...
### ![icon](../images/items/x64/Egg.png) 煎蛋 (Egg)
- **饥饿恢复**：-5（烹饪后：-10）
- **额外体力**：无（烹饪后：+10）
- **重量**：2.5
- **可烹饪**：是
